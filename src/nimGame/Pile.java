...
public class Pile {
    ...
    /**
     * Constructor creates a pile with the number of stones 
     * supplied by the argument.
     * 
     * pre: none
     * post: A pile object is created.
     * 
     ...
     * 
     *  pre: none
     *  post: numStones is set to number supplied as argument
     * 
     ...
     * 
     * pre: none
     * post: The number of stones is decreased by num.
     * 
    ...
    /**
     * A string representing the pile object including
     * the number of stones contained in the pile.
     * 
     * pre: none
