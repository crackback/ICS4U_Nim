...
public class Player {
    ...
    /**
     * Allows the player to remove stones from the pile. Checks number 
     * of stones in pile and only allows valid moves of one two or three.
     * 
     * pre: pile must contain > 0 stones
     * post: pile size decreased by 1, 2 or 3
     * 
     * @param Pile p 
     */
